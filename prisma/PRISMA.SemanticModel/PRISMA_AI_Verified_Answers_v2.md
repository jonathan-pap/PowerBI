# PRISMA — Power BI AI Verified Answers & Visual Filters (v2)

> 5 verified answers per visual — focused on the most distinct and high-value questions.
> KPI tiles excluded. Up to 3 additional filters per visual.

---

## Page 1 — Executive Summary

### Net Profit vs Net Revenue *(line chart)*
...
### Margin % vs Prior Year *(line chart)*
...
### Net Revenue by Channel *(line chart)*
...
**Filters:** `Store[Country]` · `Store[Store Status]` · `Date[Year]`
...
**Filters:** `Date[Year]` · `Store[Store Status]` · `Product[Category]`
...
2. How does Contoso compare to Wide World Importers?
3. Which brands generate more than 200M in revenue?
4. Which brand is the weakest performer?
5. How does Fabrikam compare to Proseware?
...
**Filters:** `Date[Year]` · `Customer[Gender]` · `Customer[Age Band]`
1. Which country has the highest revenue per customer?
2. Which country has the lowest revenue per customer?
3. How does Germany compare to Italy in revenue per customer?
...
3. How does the 18-29 age band compare to the 60-74 age band?
...
5. How does France repeat rate compare to Canada?
...
*PRISMA — adaptfy · 5 pages · 19 visuals · 5 verified answers each · 3 filters each*
